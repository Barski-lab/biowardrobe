                                         ...
                                         items:[{
                                                 ...
                                                 items:[{
                                                         ...
                                                         html: '<div class="panel-text">'+
                                                               ...
                                                               'To apply a filter at first you have to type filter name which will be assigned to the result.'+
                                                               ' Then choose which annotation grouping to apply (isoforms, genes, common tss).'
                                                               +' After that in "Filter" fieldset you should choose data source and field which you want to filter,'+
                                                               ' it has to be at least one record, to add more press "+", to delete press "x".'+
                                                               ' '
                                                               +'</div>'
                                                     }]
                                             }]
                                         ...
                                         items: [
                                             {
                                                 ...
                                                 valueField: 'id',
                                                 editable: false,
                                                 value: me.deseq?me.initialConfig.rtype_id:
                                                                  LocalStorage.getParam(LocalStorage.PARAMS_STORAGE,'default_annotation_grouping'),
                                                                  id: 'filter-rna-type',
                                                                  afterLabelTextTpl: required,
               ...
               addSubFilter: function(filterc,pf,params) {
                   ...
                   var subf={
                       ...
                       items: [{
                               ...
                               store: (parseInt(me.checkVal(params,'field',1))===2 && !me.deseq) ||
                                      (parseInt(me.checkVal(params,'field',1))===6 && me.deseq)
                                      ?me.filterschr:me.filters,
                                        flex: 2,
                                        editable: false,
                                        margin: '0 0 0 6'
