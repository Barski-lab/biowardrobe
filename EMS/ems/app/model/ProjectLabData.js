...
Ext.define( 'EMS.model.ProjectLabData', {
               ...
               fields: [
                   ...
                   { name: 'combined', mapping: null, type: 'string', persist: false,
                       convert: function(value, record) {

                           return Ext.String.format('<small>id: <i>{0}</i> date: <i>{1}</i></small>'+
                                                    '<br>{2}<br>{3}<br>{4}',
                                                    record.data['id'],
                                                    Ext.util.Format.date(record.data['dateadd'],'m/d/Y'),
                                                    record.data['cells'],
                                                    record.data['conditions'],
                                                    record.data['name4browser']);
                       }
                   },
