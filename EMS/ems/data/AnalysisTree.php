...
if($_REQUEST['node']=='root') {
    ...
    $query_array=execSQL($con,"SELECT a1.id,a1.name,IF(a1.status=0,IF(IFNULL(count(a2.ahead_id),0)>0,1,0),a1.status) as status,a1.atype_id,a1.project_id,count(a2.ahead_id) as children
