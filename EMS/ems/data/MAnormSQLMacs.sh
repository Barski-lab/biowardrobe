...
mysql -ureadonly -hlocalhost -P3306 -preadonly --disable-column-names -e "select chrom,start-$7,end+$7 from $1" ${10} >peak1.bed
mysql -ureadonly -hlocalhost -P3306 -preadonly --disable-column-names -e "select chrom,start-$8,end+$8 from $2" ${10} >peak2.bed
