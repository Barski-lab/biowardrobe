...
Ext.define("Chart.ux.Highcharts", {
    ...
    afterRender: function () {
        ...
        // Sencha Touch uses config to access properties
        var _this = this;//(this.statics().sencha.product == 't') ? this.config : this;
        ...
        // 4.0.x
        Ext.applyIf(_this.chartConfig.chart, {
            renderTo: this.el.dom //(this.statics().sencha.product == 't') ? this.element.dom : this.el.dom
        });
    ...
    buildInitData: function () {
        ...
        this.log('Build init data');
        var data = [], seriesCount = (_this.series?_this.series.length:0), i;
