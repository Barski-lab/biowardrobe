...
DROP TABLE IF EXISTS `ems`.`advanced_r`;
CREATE TABLE `ems`.`advanced_r` (
...
INSERT INTO `ems`.`advanced_r`(`id`,`name`,`rscript`) 
VALUES ('PCA00000-0000-0000-0000-000000000001','PCA',
